...
namespace RUL
{
    //Simplex noise generation based on code by Stefan Gustavson (http://webstaff.itn.liu.se/~stegu/simplexnoise/)
    internal class SimplexOctave
    {
        #region Private Fields

        private static Grad[] _grad3 = {new Grad(1,1,0),new Grad(-1,1,0),new Grad(1,-1,0),new Grad(-1,-1,0),
                                       new Grad(1,0,1),new Grad(-1,0,1),new Grad(1,0,-1),new Grad(-1,0,-1),
                                       new Grad(0,1,1),new Grad(0,-1,1),new Grad(0,1,-1),new Grad(0,-1,-1)};
        //numbers between 0 and 255, randomly ordered
        private static short[] _pSupply = { 151,160,137,91,90,15,
        ...
        private short[] _p = new short[_pSupply.Length];

        //Doubled permutation table length
        ...
        private const double F2 = 0.5 * (1.73205 - 1.0);
        private const double G2 = (3.0 - 1.73205) / 6.0;
        ...
        public double SimplexNoiseAt(double xin, double yin)
        {
            ...
            //Work out hashed gradient indeces of the three simplex corners
            int ii = i & 255;
            int jj = j & 255;
        ...
        public double SimplexNoiseAt(double xin, double yin, double zin)
        {
